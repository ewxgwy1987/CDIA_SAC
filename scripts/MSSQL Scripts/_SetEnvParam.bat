...
REM #       C:\PterisGlobal\BHS\SAC\Bin
REM #       D:\PterisGlobal\BHS\SAC\Log
REM #######################################################################

REM SETX PALS_BHS_BIN "C:\PterisGlobal\BHS\SAC\Bin" /M
SETX PALS_BHS_LOG "C:\PterisGlobal\BHS\SAC\Log" /M
PAUSE
