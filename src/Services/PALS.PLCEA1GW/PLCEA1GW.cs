...
{
    public partial class PLCEA1GW : ServiceBase
    {
       private const string SERVICE_NAME = "PALS.PLCEA1GW";
        ...
        public PLCEA1GW()
        {
            ...
            if (!System.Diagnostics.EventLog.SourceExists("PALS.PLCEA1GW"))
            {
                System.Diagnostics.EventLog.CreateEventSource(
                    "PALS.PLCEA1GW", "Application");
            }
            eventLog1.Source = "PALS.PLCEA1GW";
        ...
        protected override void OnStart(string[] args)
        {
            ...
            try
            {
                ...
                string xmlSettingFile = PALS.Utilities.Functions.GetXMLFileFullName("PALS_BASE", "CFG_PLCEA1GW.xml", 5);
                if (xmlSettingFile == null)
                {
                    // Read XML configuration file from \MessageRouter sub folder.
                    xmlSettingFile = PALS.Utilities.Functions.GetXMLFileFullName("PALS_BASE", @"SAC\CFG_PLCEA1GW.xml", 5);
