...
{
    public partial class SCPLCEM1GW : ServiceBase
    {
       private const string SERVICE_NAME = "PALS.SCPLCEM1GW";
        ...
        public SCPLCEM1GW()
        {
            ...
            if (!System.Diagnostics.EventLog.SourceExists("PALS.SCPLCEM1GW"))
            {
                System.Diagnostics.EventLog.CreateEventSource(
                    "PALS.SCPLCEM1GW", "Application");
            }
            eventLog1.Source = "PALS.SCPLCEM1GW";
        ...
        protected override void OnStart(string[] args)
        {
            ...
            try
            {
                ...
                if (xmlSettingFile == null)
                {
                    ...
                    xmlSettingFile = PALS.Utilities.Functions.GetXMLFileFullName("PALS_BASE", @"SAC\CFG_SCPLCEM1GW.xml", 5);
                    ...
                    if (xmlSettingFile == null)
                        throw new Exception("XML configuration file (CFG_SCPLCEM1GW.xml) could not be found! " +
                                    ...
                                    "or file CFG_SCPLCEM1GW.xml is existing in the folder {PALS_BASE}\\SAC\\");
                }
